...
public class ExcelUtil {
	...
	public static HashMap<Integer,TbSales> classMap=new HashMap<Integer,TbSales>();
	...
	public static boolean isEmpty(XSSFCell cell){
		return cell==null?true:cell.getCellType()==XSSFCell.CELL_TYPE_BLANK;
	}
	
	public static boolean isNum(XSSFCell cell){
