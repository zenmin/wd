	...
	$(function() {
		$('#sub').click(function() {
			...
			if (file.val() == '') {
			    ...
			    $("#msg").text("正在提交更新,请稍后...");
			    $.dialog('alert','提示','正在提交更新中... 数据较大更新会很缓慢，请耐心等待 不要刷新页面！',5000); //不自动关闭
				$.ajax({
					cache : false,
					url : "updateSales",
					method : "post",
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">销售数据更新</h1>
		</div>
	</div>
	<!--/.row-->
	<!-- 行列 -->
	...
	<p align="center">从唯品会后台-商品-商品详情(按条码,分区)导出,一次更新一个表格
	<br>
	  <a href="excel/xiaoshou.xlsx">点击下载示例销售流水Excel表</a>
	  </p>
